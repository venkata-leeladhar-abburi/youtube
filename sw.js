...
ytcfg.set({
    "EXPERIMENT_FLAGS": {
        ...
        "hide_cta_for_home_web_video_ads_animate_in_time": 5,
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20240123.06.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "en",
            "gl": "IN",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20240123.06.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/54055272\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/54055272\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}