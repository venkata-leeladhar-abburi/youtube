(function() {
    ...
    */
    ...
    function rb(a, b) {
        ...
        for (var c = 0, d, e = void 0, f, g = void 0; c < b.length; c++)
            if (d = b[c], f = ob(d), f !== e && (g = a.indexOf(f), e = f), !y(f) || -1 < g) return d
    }
    var sb = {
            get composed() {
            ...
            if ("function" === l || "object" === l)
                if ("object" !== l || b.handleEvent && "function" === typeof b.handleEvent) {
                    ...
                    h = function(n) {
                        ...
                        if (!y(m) && "slot" !== m.localName || -1 != n.composedPath().indexOf(m))
                            if (n.composed || -1 < n.composedPath().indexOf(m))
    ...
    var hc = C({
        ...
        insertBefore: function(a, b) {
            ...
            f = !0;
            var l = (!Zb || void 0 === a.__noInsertionPoint && void 0 ===
                    this.__noInsertionPoint) && !Vb(a, e),
            ...
            f ? (c = y(this) ? this.host : this, b ? (b = dc(b), c.__shady_native_insertBefore(a, b)) : c.__shady_native_appendChild(a)) : a.ownerDocument !==
    ...
    */
    ...
    var Dc = C({
        ...
        addEventListener: function(a, b, c) {
            if ("slot" !== this.localName || "slotchange" === a) Db.call(this, a, b, c);
            else {
                "object" !== typeof c && (c = {
                    capture: !!c
                });
        ...
        removeEventListener: function(a,
            b, c) {
            if ("slot" !== this.localName || "slotchange" === a) Eb.call(this, a, b, c);
            else {
                "object" !== typeof c && (c = {
                    capture: !!c
                });
    ...
    */
            ...
            if (c.target !== document.documentElement && c.target !== document.head)
                for (var d = 0; d < c.addedNodes.length; d++) {
                    ...
                    if (e.nodeType === Node.ELEMENT_NODE) {
                        var f = e.getRootNode(),
                            g = ze(e);
                        if (g && f === e.ownerDocument && ("style" !== e.localName && "template" !== e.localName || "" === Ld(e))) Rd(e, g);
    ...
    k.Va = function(a, b) {
        ...
        Q ? l.J ? (l.J.textContent = g, e = l.J) : g && (e = Dd(g, h, a.shadowRoot, l.placeholder)) : e ? e.parentNode || (ge && -1 < g.indexOf("@media") && (e.textContent = g), Ed(e, null, l.placeholder)) : g && (e = Dd(g, h, null, l.placeholder));
