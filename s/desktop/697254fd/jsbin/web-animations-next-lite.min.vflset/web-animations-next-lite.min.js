...
(function() {
    ...
    (function(y, v) {
        ...
        function h(p, w, z) {
            ...
            "number" != typeof p || isNaN(p) ? void 0 !== p && Object.getOwnPropertyNames(p).forEach(function(B) {
                if ("auto" !=
                    p[B]) {
                    if ("number" == typeof A[B] || "duration" == B)
                        if ("number" != typeof p[B] || isNaN(p[B])) return;
        ...
        function d(p, w, z, A) {
            return 0 > p || 1 < p || 0 > z || 1 < z ? n : function(B) {
                ...
                if (1 <= B) return D = 0, 1 > z ? D = (A - 1) / (z - 1) : 1 == z && 1 > p && (D = (w - 1) /
                    (p - 1)), 1 + D * (B - 1);
                D = 0;
                for (var H = 1; D < H;) {
                    var E = (D + H) / 2,
        ...
        k.prototype = {
            ...
            set iterationStart(p) {
                if ((isNaN(p) ||
                        0 > p) && f()) throw new TypeError("iterationStart must be a non-negative number, received: " + p);
        ...
        y.calculateIterationProgress = function(p, w, z) {
            ...
            p = B;
            B = 2 === A && Infinity === z.iterations ? Infinity : 1 === p ? Math.floor(w) -
                1 : Math.floor(w);
            w = A = z.direction;
        ...
        function k(a) {
            ...
            for (b in a)
                if (!(b in ["easing", "offset", "composite"])) {
                    var g = a[b];
                    Array.isArray(g) || (g = [g]);
                    for (var e, m = g.length, n = 0; n < m; n++) e = {}, e.offset = "offset" in a ? a.offset : 1 == m ? 1 : n / (m - 1), "easing" in a && (e.easing =
        ...
        y.normalizeKeyframes = function(a) {
            ...
            var b = a.map(function(n) {
                ...
                for (r in n) {
                    ...
                    t = l;
                    var C = u;
                    if ("display" !== C && 0 !== C.lastIndexOf("animation", 0) && 0 !== C.lastIndexOf("transition", 0))
                        if (C = f[u])
                            for (x in h.style[u] = q, C) {
                                q = u = C[x];
                                var p = h.style[u];
                                t[u] = q in d ? d[q][p] || p : p
                            } else t[u] = u in d ? d[u][q] || q : q
                }
                void 0 ==
                    l.offset && (l.offset = null);
    ...
    (function(y) {
        ...
        y.isDeprecated = function(k, f, h, d) {
            ...
            return a < f ? (k in v || console.warn("Web Animations: " +
                k + " " + d + " deprecated and will stop working on " + f.toDateString() + ". " + h), v[k] = !0, !1) : !0
        };
    ...
    (function() {
        if (document.documentElement.animate) {
            ...
            function d(c) {
                for (var b = {}, g = 0; g < c.length; g++)
                    for (var e in c[g])
                        if ("offset" != e && "easing" != e && "composite" != e) {
                            var m = {
                                offset: c[g].offset,
                                easing: c[g].easing,
                                value: c[g][e]
                ...
                for (var n in b)
                    if (c = b[n], 0 != c[0].offset || 1 != c[c.length - 1].offset) throw {
                        type: DOMException.NOT_SUPPORTED_ERR,
                        name: "NotSupportedError",
            ...
            f.convertEffectInput = function(c) {
                ...
                return function(e, m) {
                    if (null != m) g.filter(function(l) {
                        ...
                        for (var n in b) "offset" != n && "easing" != n && "composite" != n && f.clear(e, n)
                }
            }
        })(G, F, null);
        (function(k, f, h) {
            ...
            f.propertyInterpolation = function(b,
                g, e) {
                var m = b;
        ...
        (function(k, f) {
            function h(d, a, c) {
                ...
                throw "Mismatched interpolation arguments " + d + ":" +
                    a;
            }
        ...
        (function(k, f, h) {
            ...
            f.Animation.prototype = {
                ...
                _rewind: function() {
                    if (0 <=
                        this._playbackRate) this._currentTime = 0;
                    else if (Infinity > this._totalDuration) this._currentTime = this._totalDuration;
                ...
                _markTarget: function() {
                    var a =
                        this._targetAnimations(); - 1 === a.indexOf(this) && a.push(this)
                },
            ...
            f.applyDirtiedAnimation = function(q) {
                x || (q._markTarget(),
                    q = q._targetAnimations(), q.sort(a), g(f.timeline.currentTime, !1, q.slice())[1].forEach(function(C) {
                        C = u._animations.indexOf(C); - 1 !== C && u._animations.splice(C, 1)
                    }), b())
            };
            var t = [],
                x = !1,
        ...
        (function(k, f) {
            ...
            function d(c, b) {
                return [c, b, function(g) {
                    if (g[3])
                        for (var e = 0; 3 > e; e++) g[e] = Math.round(Math.max(0, Math.min(255, g[e] / g[3])));
    ...
    (function(y) {
        var v = document.documentElement,
            ...
            f = !1;
        try {
            var h = "0" == getComputedStyle(v).getPropertyValue("opacity") ?
                "1" : "0";
            k = v.animate({
                opacity: [h, h]
            }, {
            ...
            _forEachChild: function(f) {
                ...
                if ("pending" != this.playState) {
                    var d = this.effect._timing,
                        a = this.currentTime;
                    null !== a && (a = y.calculateIterationProgress(y.calculateActiveDuration(d),
                        a, d));
    ...
    (function(y, v, k) {
        ...
        var d = function(e) {
            ...
            if (e instanceof window.SequenceEffect || e instanceof window.GroupEffect)
                for (var m = 0; m < e.children.length; m++) d(e.children[m])
        };
        v.removeMulti = function(e) {
            for (var m = [], n = 0; n < e.length; n++) {
                var l = e[n];
                l._parent ? (-1 == m.indexOf(l._parent) &&
                    m.push(l._parent), l._parent.children.splice(l._parent.children.indexOf(l), 1), l._parent = null, d(l)) : l._animation && l._animation.effect == l && (l._animation.cancel(), l._animation.effect = new KeyframeEffect(null, []), l._animation._callback && (l._animation._callback._animation = null), l._animation._rebuildUnderlyingAnimation(), d(l))
            }
    ...
    (function(y, v, k) {
        ...
        function h(b) {
            ...
            b = b.filter(function(g) {
                g();
                var e = g._animation ? g._animation.playState :
                    "idle";
        ...
        v.bindAnimationForCustomEffect = function(b) {
            ...
            var r = function() {
                ...
                null !== t && (t =
                    y.calculateIterationProgress(y.calculateActiveDuration(n), t, n), isNaN(t) && (t = null));
    ...
    (function(y, v, k) {
        ...
        h.prototype = {
            ...
            _rebuild: function() {
                for (var d = this; d;) "auto" ===
                    d.timing.duration && (d._timing.duration = d.activeDuration), d = d._parent;
                this._animation && this._animation._rebuildUnderlyingAnimation()
            },
            ...
            _putChild: function(d, a) {
                ...
                for (b = 0; b < d.length; b++) a ? this.children.push(d[b]) :
                    this.children.unshift(d[b]);
                this._reparent(d);
                this._rebuild()
            },
            append: function() {
            ...
            clone: function() {
                ...
                GroupEffect ? new GroupEffect(a, d) : new SequenceEffect(a, d)
            },
            remove: function() {
                v.removeMulti([this])
            }
