(function() {
    ...
    */
    ...
    function fa() {
        if (ea !== ea) throw Error("SafeStyleSheet is not meant to be built directly");
    }
    ...
    function ra(a) {
        for (var b = new oa; a;) a.F.forEach(function(c) {
            c(b)
        }), a = a.i
    }
    ...
    */
    ...
    function ua(a) {
        ...
        if (b = G(H(), "safevalues").G) {
            ...
            c && (b = G(H(), b.g()), "function" === typeof a && a(), na || (na = new ma), ra(b))
        }
    ...
    var J = window.performance && window.performance.timing && window.performance.now ? function() {
    ...
    function Ba(a) {
        a.data && "[object String]" == Object.prototype.toString.call(a.data) && 0 == a.data.lastIndexOf("spf:", 0) && Ca(a.data.substring(4))
    }
    ...
    T = N["async-defers"];
    Fa && ("async-listener" in N && Ea(N["async-listener"]), Da(Ba), M("async-listener", Ba));
    var Ga = {};
    "ps-s" in N || M("ps-s", Ga);
    Ga = N["ps-s"];
    ...
    */
    ...
    function W(a) {
        var b = new Oa;
        if (!a) return b;
        if ("[object String]" != Object.prototype.toString.call(a)) return a.scripts && K(a.scripts, function(c) {
            b.scripts.push({
                url: c.url || "",
                text: c.text || "",
                name: c.name || "",
        ...
        }), a.styles && K(a.styles, function(c) {
            b.styles.push({
                url: c.url || "",
                text: c.text || "",
                name: c.name || ""
            })
        }), a.links && K(a.links, function(c) {
        ...
        a = a.replace(Pa, function(c, d, e, f) {
            ...
            return "style" == d && (d = (d = e.match(X)) ? d[1] : "", e = Sa.exec(e), e = !e || -1 != e[1].indexOf("text/css")) ? (b.styles.push({
                url: "",
                text: f,
                name: d
            }), "") : c
        ...
        a = a.replace(Ta, function(c, d) {
            var e = d.match(Ua);
            e = e ? e[1] : "";
            return "stylesheet" == e ? (e = (e = d.match(X)) ? e[1] : "", d = (d = d.match(Va)) ? d[1] :
                "", b.styles.push({
                    url: d,
                    text: "",
                    name: e
                }), "") : "spf-preconnect" == e ? (d = (d = d.match(Va)) ? d[1] : "", b.links.push({
                url: d,
                rel: e
            }), "") : c
        });
    ...
    function Oa() {
        ...
        return "transition" in a.style ? !0 : wa(["webkit", "Moz", "Ms", "O", "Khtml"], function(b) {
            return b + "Transition" in a.style
        })
    })();
    var Ta = /\x3clink([\s\S]*?)\x3e/ig,
        Pa = /\x3c(script|style)([\s\S]*?)\x3e([\s\S]*?)\x3c\/\1\x3e/ig,
        Ra = /(?:\s|^)async(?:\s|=|$)/i,
        Va = /(?:\s|^)href\s*=\s*["']?([^\s"']+)/i,
        X = /(?:\s|^)name\s*=\s*["']?([^\s"']+)/i,
        Ua = /(?:\s|^)rel\s*=\s*["']?([^\s"']+)/i,
    ...
    function Wa(a, b, c, d) {
        ...
        g.onreadystatechange = function() {
            ...
            if (2 == g.readyState) {
                ...
                else if (O["assume-all-json-requests-chunked"] || -1 < (g.getResponseHeader("Transfer-Encoding") || "").toLowerCase().indexOf("chunked")) f = !0;
                else {
                ...
                e.u && e.u(g)
            } else 3 == g.readyState ? f && e.m && (q = g.responseText.substring(h), h = g.responseText.length, e.m(g, q)) : 4 == g.readyState && (q.responseEnd = q.responseEnd || J(), window.performance && window.performance.getEntriesByName && (g.resourceTiming = window.performance.getEntriesByName(b).pop()), f && e.m && g.responseText.length > h && (q = g.responseText.substring(h), h = g.responseText.length, e.m(g, q)), clearTimeout(k), e.s && e.s(g))
        };
    ...
    function Xa(a, b, c, d, e) {
        ...
        b.type && 0 == b.type.lastIndexOf("navigate", 0) && (c.navigationStart = c.startTime, O["cache-unified"] || (xa(d), f = !0));
        b.l && "multipart" == e.type && K(e.parts, function(h) {
            h.timing || (h.timing = {});
    ...
    function ab(a, b, c, d, e) {
        ...
        if (b.l && 1 < g.length)
            for (d = d.g.length; d < g.length; d++) e = g[d], e.timing || (e.timing = {}), e.timing.spfCached = !!c.spfCached, e.timing.spfPrefetched = !!c.spfPrefetched, b.l(a, e);
        if (1 < g.length) {
            var m;
            K(g, function(t) {
    ...
    function bb(a, b, c, d, e) {
        a = Ha(a);
        var f;
        O["cache-unified"] ? f = a : "navigate-back" == d || "navigate-forward" == d ? f = "history " + a : "navigate" == d ? f = (e ? "history " : "prefetch ") + a : "prefetch" == d && (f = e ? "prefetch " + a : "");
    ...
    var hb = {
            request: function(a, b) {
                ...
                if (h) {
                    ...
                    if (m = O["advanced-header-identifier"]) h["X-SPF-Request"] = m.replace("__type__", b.type), h.Accept = "application/json";
                    m = new db;
                    f = I(ab, null, a, b, c, m);
                    a = {
                        headers: h,
                    ...
                    a = "POST" == b.method ? Wa("POST", d, b.H, a) : Wa("GET", d, null, a)
                }
                return a
            }
        },
